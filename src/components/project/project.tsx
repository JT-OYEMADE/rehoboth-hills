  ...
  return (
    <>
      {isAboveMediumScreens ? (
        ...
        <div className=" slides doctorss relative ">
        <img src={image} alt={headT} className="" />
        <div className=" bg-[#FFF] px-[22px] pt-[20px] pb-[47px]  md:top-[110px] border-[0.5px] ">
          <h2 className=" text-[32px] text-[#111]">{headT}</h2>
          <p className=" font-light text-[14px] mb-6">{text}</p>
          <h6 className=" text-xs font-semibold">{sHeadT}</h6>
          <ol className="list-decimal  font-light text-[12px] leading-normal ml-4 w-[296px] mb-6">
            <li>{list_one}</li>
            <li>{list_two}</li>
            <li>{list_three}</li>
          </ol>
          <div className=" mb-1">
            <span className=" font-light text-[12px]">Location:</span>
            <span className=" font-medium text-[12px]"> {location}</span>
          </div>
          <div className=" mb-1">
            <span className=" font-light text-[12px]">Price:</span>
            <span className=" font-medium text-[12px]"> {price}</span>
          </div>
          <div className=" mt-3">
            <a href="" className="border-b pb-1 border-[#00000080]" >BUY NOW</a>
