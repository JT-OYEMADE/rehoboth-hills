...
const OurProject = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section id="ourproduct" className="mx-auto min-h-full w-5/6 py-20 font-haskoy overflow-x-hidden">
      ...
      >
        ...
        <div className="flex flex-row item-center gap-3 font-haskoy font-light md:-mt-16 md:absolute ">
          <div onClick={scrollDoctorsLeft} className="flex flex-row items-center gap-x-1 cursor-pointer">
            ...
            <span className="hover:text-[#11111180]">Previous Project</span>
          </div>
          <div onClick={scrollDoctorsRight} className="cursor-pointer flex flex-row items-center gap-x-1">
            <span className="hover:text-[#11111180]">Next Project</span>
            <span>
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
